...
public static class Communicator
{
    ...
    public static void PrintIdentifiedItem(string name, IGatherable? item)
    {
        ...
        GatherBuddy.Log.Verbose(Configuration.DefaultIdentifiedGatherableFormat, item.ItemId, item.Name[ClientLanguage.Korean], name);
    }
    ...
    public static void PrintAlarmMessage(Alarm alarm, ILocation location, TimeInterval uptime)
    {
        ...
        GatherBuddy.Log.Verbose(Configuration.DefaultAlarmFormat, alarm.Name, alarm.Item.Name[ClientLanguage.Korean], string.Empty,
